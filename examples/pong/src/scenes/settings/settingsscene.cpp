...
SettingsScene::SettingsScene (const RDGE::Window& window)
    : RDGE::GameObjects::Scene(window)
{
    auto font_path = RDGE::Application::BasePath() + "res/fonts/OpenSansPX.ttf";
    auto font = std::make_shared<RDGE::Font>(font_path, 128);
    ...
    auto fn_click = std::bind(&SettingsScene::OnButtonClick, this, std::placeholders::_1);
...
void
SettingsScene::OnButtonClick (const RDGE::Controls::ControlEventArgs& args)
{
    using namespace RDGE::GameObjects;

...
void
ImGui_ImplRDGE_RenderDrawLists (ImDrawData* draw_data)
{
...
static const char*
ImGui_ImplRDGE_GetClipboardText (void*)
{
    return SDL_GetClipboardText();
}

static void
ImGui_ImplRDGE_SetClipboardText (void*, const char* text)
{
    SDL_SetClipboardText(text);
}

bool
ImGui_ImplRDGE_ProcessEvent (SDL_Event* event)
{
    ImGuiIO& io = ImGui::GetIO();
    switch (event->type)
    {
...
void
ImGui_ImplRDGE_CreateFontsTexture (void)
{
    // Build texture atlas
    ImGuiIO& io = ImGui::GetIO();
...
bool
ImGui_ImplRDGE_CreateDeviceObjects (void)
{
    // Backup GL state
...
#undef OFFSETOF
    ...
    ImGui_ImplRDGE_CreateFontsTexture();
...
void
ImGui_ImplRDGE_InvalidateDeviceObjects (void)
{
...
ImGui_ImplRDGE_Init (SDL_Window* window)
{
    ...
    io.RenderDrawListsFn = ImGui_ImplRDGE_RenderDrawLists;
    io.SetClipboardTextFn = ImGui_ImplRDGE_SetClipboardText;
    io.GetClipboardTextFn = ImGui_ImplRDGE_GetClipboardText;
...
void
ImGui_ImplRDGE_NewFrame (SDL_Window* window)
{
    if (!g_FontTexture)
    {
        ImGui_ImplRDGE_CreateDeviceObjects();
    }
